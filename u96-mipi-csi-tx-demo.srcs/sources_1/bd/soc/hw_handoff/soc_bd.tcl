...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.TDATA_REMAP {6'b000000,tdata[23:16],6'b000000,tdata[15:8],6'b000000,tdata[7:0],6'b000000} \
   CONFIG.TDEST_REMAP {tdest[0:0]} \
   CONFIG.TID_REMAP {tid[0:0]} \
   CONFIG.TKEEP_REMAP {3'b111,tkeep[2:0]} \
   CONFIG.TLAST_REMAP {tlast[0]} \
   CONFIG.TSTRB_REMAP {3'b111,tstrb[2:0]} \
  ...
  set mipi_csi2_tx_subsyst_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:mipi_csi2_tx_subsystem:2.0 mipi_csi2_tx_subsyst_0 ]
  set_property -dict [ list \
   CONFIG.C_CSI_AXIS_TDATA_WIDTH {42} \
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_1/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins mipi_csi2_tx_subsyst_0/s_axi]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets v_tpg_0_m_axis_video] [get_bd_intf_pins axis_subset_converter_0/S_AXIS] [get_bd_intf_pins ila_1/SLOT_0_AXIS]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_100/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_1/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_1/pl_clk0]
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins proc_sys_reset_100/interconnect_aresetn]
  connect_bd_net -net Net [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins ila_1/clk] [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_aclk] [get_bd_pins proc_sys_reset_150/slowest_sync_clk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_1/pl_clk1]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_1/pl_ps_irq0]
  connect_bd_net -net mipi_csi2_tx_subsyst_0_interrupt [get_bd_pins mipi_csi2_tx_subsyst_0/interrupt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net proc_sys_reset_100_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_150/peripheral_aresetn] [get_bd_pins v_tpg_0/ap_rst_n]
  connect_bd_net -net proc_sys_reset_100_peripheral_aresetn1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_100/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconcat_1/In4] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins mipi_csi2_tx_subsyst_0/s_axis_tdest] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_100/ext_reset_in] [get_bd_pins proc_sys_reset_150/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_1/pl_resetn0]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk2 [get_bd_pins mipi_csi2_tx_subsyst_0/dphy_clk_200M] [get_bd_pins zynq_ultra_ps_e_1/pl_clk2]

  # Create address segments
  assign_bd_address -offset 0xA0002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_1/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_1/Data] [get_bd_addr_segs mipi_csi2_tx_subsyst_0/s_axi/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_1/Data] [get_bd_addr_segs v_tpg_0/s_axi_CTRL/Reg] -force
