...
HD_PWD='/home/rouholla/myData/zynq_projects/Vitis_Projects/ultra96_platform/ultra96_platform.runs/soc_proc_sys_reset_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_proc_sys_reset_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_proc_sys_reset_0_4.tcl
